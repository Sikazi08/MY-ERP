...
import { Loader2, Plus, Search, Download, Trash2, Edit2 } from "lucide-react";
...
export default function Stock() {
  ...
  }, { query: { queryKey: getListProductsQueryKey({ search: search || undefined, status: statusFilter !== "all" ? statusFilter : undefined }) } });
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center bg-card p-4 rounded-lg border border-border">
        <div className="relative flex-1 w-full">
          ...
          <Input 
            placeholder="Rechercher par ID, IMEI, produit, marque..." 
              ...
              {isLoading ? (
                ...
                products.map((product) => (
                  ...
                  >
                    ...
                    <TableCell className="font-medium text-foreground">{product.product}</TableCell>
                    <TableCell className="text-muted-foreground text-sm">{product.imei || "-"}</TableCell>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4 bg-muted/30 p-4 rounded-lg border border-border">
                <div>
                  ...
                  <p className="font-medium">{selectedProduct.imei || "-"}</p>
                </div>
                <div>
                  <Label className="text-xs text-muted-foreground">Capacité / Couleur</Label>
                  <p className="font-medium">{selectedProduct.capacity || "-"} / {selectedProduct.color || "-"}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="font-medium">{formatDateFr(selectedProduct.entryDate)}</p>
                </div>
              </div>
